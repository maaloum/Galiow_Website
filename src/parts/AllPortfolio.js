        ...
        <Tabs className="flex flex-col px-4">
          <TabList>
            <div className="flex flex-row mb-5">
              <Tab>
                <button className="font-normal px-5 py-2 mr-3 text-theme-purple text-lg border border-theme-purple rounded-full transition duration-300 hover:bg-theme-purple hover:text-yellow-300 focus:outline-none focus:bg-theme-purple focus:text-yellow-300">
                  Website
                </button>
              </Tab>
              <Tab>
              ...
              <Tab>
                <button className="font-normal px-8 py-2 text-theme-purple text-lg border border-theme-purple rounded-full transition duration-300 hover:bg-theme-purple hover:text-yellow-300 focus:outline-none focus:bg-theme-purple focus:text-yellow-300">
                  UI/UX
                </button>
              </Tab>
            </div>
